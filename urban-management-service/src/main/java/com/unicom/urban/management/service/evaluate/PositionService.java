    ...
    public List<SupervisorEvaluateVO> findSupervisorEvaluateByCondition(String time1, String time2) {
        ...
        if (mapList != null && mapList.size() > 0) {
            for (Map<String, Object> map : mapList) {
                ...
                sVO.setInTimeVerifyRate(map.get("inTimeVerifyRate") == null ? "0%" : ((Float.parseFloat(map.get("inTimeVerifyRate").toString())) * 100) + "%");
                ...
                sVO.setPublicReportRate(map.get("publicReportRate") == null ? "0%" : ((Float.parseFloat(map.get("publicReportRate").toString())) * 100) + "%");
    ...
    public List<AcceptorEvaluateVO> findAcceptorEvaluateByCondition(String time1, String time2) {
        ...
        if (mapList != null && mapList.size() > 0) {
            for (Map<String, Object> map : mapList) {
                ...
                sVO.setSendVerifyRate(map.get("sendVerifyRate") == null ? "0%" : ((Float.parseFloat(map.get("sendVerifyRate").toString())) * 100) + "%");
    ...
    public List<ShiftForemanEvaluateVO> findShiftForemanEvaluateByCondition(String time1, String time2) {
        ...
        if (mapList != null && mapList.size() > 0) {
            for (Map<String, Object> map : mapList) {
                ...
                sVO.setIntimeInstRate(map.get("intimeInstRate") == null ? "0%" : ((Float.parseFloat(map.get("intimeInstRate").toString())) * 100) + "%");
                sVO.setExactInst(map.get("exactInst") == null ? 0 : (Integer.parseInt(map.get("exactInst").toString())));
                sVO.setExactInstRate(map.get("exactInstRate") == null ? "0%" : ((Float.parseFloat(map.get("exactInstRate").toString())) * 100) + "%");
                ...
                sVO.setInTimeCloseRate(map.get("inTimeCloseRate") == null ? "0%" : ((Float.parseFloat(map.get("inTimeCloseRate").toString())) * 100) + "%");
                sVO.setAggregativeIndicator(map.get("aggregativeIndicator") == null ? "0%" : ((Float.parseFloat(map.get("aggregativeIndicator").toString())) * 100) + "%");
                sVO.setRatingLevel(map.get("ratingLevel") == null ? "" : map.get("ratingLevel").toString());
                list.add(sVO);
            }
    ...
    public List<DispatcherEvaluateVO> findDispatcherEvaluateByCondition(String time1, String time2) {
        ...
        if (mapList != null && mapList.size() > 0) {
            for (Map<String, Object> map : mapList) {
                ...
                sVO.setIntimeDispatchRate(map.get("intimeDispatchRate") == null ? "0%" : ((Float.parseFloat(map.get("intimeDispatchRate").toString())) * 100) + "%");
                sVO.setAccuracyDispatch(map.get("accuracyDispatch") == null ? 0 : (Integer.parseInt(map.get("accuracyDispatch").toString())));
                sVO.setAccuracyDispatchRate(map.get("accuracyDispatchRate") == null ? "0%" : ((Float.parseFloat(map.get("accuracyDispatchRate").toString())) * 100) + "%");
                sVO.setAggregativeIndicator(map.get("aggregativeIndicator") == null ? "0%" : ((Float.parseFloat(map.get("aggregativeIndicator").toString())) * 100) + "%");
                sVO.setRatingLevel(map.get("ratingLevel") == null ? "" : map.get("ratingLevel").toString());
                list.add(sVO);
            }
