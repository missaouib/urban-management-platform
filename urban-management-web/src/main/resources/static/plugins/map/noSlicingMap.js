...
var bounds = [593489.95, 5237489.850000007,
    598010.1499999968, 5247510.05];
var untiled = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://218.10.223.8:9050/geoserver/hegang/wms',
        params: {'FORMAT': format,
            'VERSION': '1.1.1',
            "LAYERS": 'hegang:hegang8',
...
var tiled = new ol.layer.Tile({
    ...
    source: new ol.source.TileWMS({
        ...
        params: {'FORMAT': format,
            ...
            "LAYERS": 'hegang:hegang8',
            "exceptions": 'application/vnd.ogc.se_inimage',
            tilesOrigin: 593489.95 + "," + 5237489.850000007
        }
    })
});
